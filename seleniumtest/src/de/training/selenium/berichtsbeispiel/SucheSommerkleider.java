...
public class SucheSommerkleider {
	...
	@Test
	public void sucheSommerkleider() {
		WebElement suchfeld = driver.findElement(suchfeldLokator);
		suchfeld.clear();
		suchfeld.sendKeys("summer dresses");
		suchfeld.submit();
		...
		assertEquals(driver.findElement(ergebnisseLokator).getText(), "4 results have been found.");
	}
