...
public class SucheBlusen {
	...
	public void sucheBlusen() {
		...
		assertEquals(driver.findElement(ergebnisseLokator).getText(), "1 result has been found.");
	}
